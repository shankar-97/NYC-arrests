 ...
 * Project :      DATA MODEL
 *
 * Date Created : Tuesday, April 12, 2022 00:18:30
 * Target DBMS : Microsoft SQL Server 2019
 */

USE master
go
CREATE DATABASE yeartodate
go
USE yeartodate
go
/* 
...
CREATE TABLE bdg_age(
    ...
    CONSTRAINT PK__bdg_age__DA20821AD4F35EA8 PRIMARY KEY CLUSTERED (Age_SK, Arrest_SK)
)
...
CREATE TABLE bdg_arrest_precinct(
    ...
    CONSTRAINT PK__bdg_arre__57BEB09ED66B05C0 PRIMARY KEY CLUSTERED (Arrest_Precint_SK, Arrest_SK)
)
...
CREATE TABLE bdg_date(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__bdg_date__D6222BB4803FCACE PRIMARY KEY CLUSTERED (Date_SK, Arrest_SK)
)
...
CREATE TABLE bdg_jurisdiction(
    ...
    DI_JobID           varchar(10)    NULL,
    DI_JobDate         datetime       NULL,
    CONSTRAINT PK__bdg_juri__CB5FEDDECF9F2D17 PRIMARY KEY CLUSTERED (Jurisdiction_SK, Arrest_SK)
)
...
CREATE TABLE bdg_ky(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__bdg_ky__8442B9FE1C0E7987 PRIMARY KEY CLUSTERED (KY_SK, Arrest_SK)
)
...
CREATE TABLE bdg_law(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__bdg_law__92A60360BF874F4D PRIMARY KEY CLUSTERED (LAWCD_SK, Arrest_SK)
)
...
CREATE TABLE bdg_law_category(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__bdg_law___22859371B39F4AEF PRIMARY KEY CLUSTERED (LAWCAT_SK, Arrest_SK)
)
...
CREATE TABLE bdg_pd(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__bdg_pd__FB47B63C02679D0A PRIMARY KEY CLUSTERED (PD_SK, Arrest_SK)
)
...
CREATE TABLE bdg_race(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__bdg_race__76B7B15D30774EBE PRIMARY KEY CLUSTERED (Race_SK, Arrest_SK)
)
...
CREATE TABLE bdg_sex(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__bdg_sex__5C10929B0284EBEA PRIMARY KEY CLUSTERED (Sex_SK, Arrest_SK)
)
...
CREATE TABLE dim_age(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__dim_age__139988D3A7DEA074 PRIMARY KEY CLUSTERED (Age_SK)
)
...
CREATE TABLE dim_arrest(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__dim_arre__9B90AC9DCA0CCF11 PRIMARY KEY CLUSTERED (Arrest_SK)
)
...
CREATE TABLE dim_arrest_location(
    ...
    CONSTRAINT PK__dim_arre__D553A4997F1ACC17 PRIMARY KEY CLUSTERED (Arrest_Loc_SK)
)
...
CREATE TABLE dim_arrest_precinct(
    ...
    DI_JobID             varchar(10)    NULL,
    DI_JobDate           datetime       NULL,
    CONSTRAINT PK__dim_arre__9E07BA57ED4CFD1E PRIMARY KEY CLUSTERED (Arrest_Precint_SK)
)
...
CREATE TABLE dim_date(
    ...
    DI_JobID       varchar(10)    NULL,
    DI_JobDate     datetime       NULL,
    CONSTRAINT PK__dim_date__1F9B217DA0D2003C PRIMARY KEY CLUSTERED (Date_SK)
)
...
CREATE TABLE dim_jurisdiction(
    ...
    DI_JobID             varchar(10)    NULL,
    DI_JobDate           datetime       NULL,
    CONSTRAINT PK__dim_juri__02E6E717ED9F9D82 PRIMARY KEY CLUSTERED (Jurisdiction_SK)
)
...
CREATE TABLE dim_ky(
    ...
    DI_JobID      varchar(10)     NULL,
    DI_JobDate    datetime        NULL,
    CONSTRAINT PK__dim_ky__4DFBB3371A1A204C PRIMARY KEY CLUSTERED (KY_SK)
)
...
CREATE TABLE dim_law(
    ...
    DI_JobID       varchar(10)    NULL,
    DI_Job_Date    datetime       NULL,
    CONSTRAINT PK__dim_law__5B1F09A95CD78A8C PRIMARY KEY CLUSTERED (LAWCD_SK)
)
...
CREATE TABLE dim_law_category(
    ...
    DI_JobID       varchar(10)    NULL,
    DI_Job_Date    datetime       NULL,
    CONSTRAINT PK__dim_law___EB3C99B8FA8BB4E4 PRIMARY KEY CLUSTERED (LAWCAT_SK)
)
...
CREATE TABLE dim_location(
    ...
    DI_JobID                    varchar(10)    NULL,
    DI_JobDate                  datetime       NULL,
    CONSTRAINT PK__dim_loca__D2BAF783674A3D25 PRIMARY KEY CLUSTERED (Location_SK)
)
...
CREATE TABLE dim_pd(
    ...
    DI_JobID      varchar(10)     NULL,
    DI_JobDate    datetime        NULL,
    CONSTRAINT PK__dim_pd__32FEBCF5C00F3C5F PRIMARY KEY CLUSTERED (PD_SK)
)
...
CREATE TABLE dim_race(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__dim_race__BF0EBB94EC799412 PRIMARY KEY CLUSTERED (Race_SK)
)
...
CREATE TABLE dim_sex(
    ...
    DI_JobID      varchar(10)    NULL,
    DI_JobDate    datetime       NULL,
    CONSTRAINT PK__dim_sex__95A998523CF0D7C9 PRIMARY KEY CLUSTERED (Sex_SK)
)
...
CREATE TABLE nypd_fct_locations(
    ...
    DI_JobID         varchar(10)    NULL,
    DI_JobDate       datetime       NULL,
    CONSTRAINT PK__nypd_fct__94172C239C240B21 PRIMARY KEY CLUSTERED (Arrest_SK, Arrest_Loc_SK, Location_SK)
)
...
CREATE TABLE nypd_raw(
    ...
    CONSTRAINT PK__nypd_raw__25FACC23B27C6609 PRIMARY KEY CLUSTERED (nypd_sk)
)
